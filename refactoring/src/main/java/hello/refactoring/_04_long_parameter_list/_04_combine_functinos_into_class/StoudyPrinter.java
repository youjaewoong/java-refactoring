package hello.refactoring._04_long_parameter_list._04_combine_functinos_into_class;
...
public class StoudyPrinter {

	private int totalNumberOfEvents;
	
	private List<Participant> participants;

	public StoudyPrinter(int totalNumberOfEvents, List<Participant> participants) {
